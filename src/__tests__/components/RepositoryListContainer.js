...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(within(firstRepositoryItem).getByText("Build forms in React, without the tears")).toHaveTextContent(
      ...
      expect(within(secondRepositoryItem).getByText("Flexible promise-based React data loader")).toHaveTextContent(
